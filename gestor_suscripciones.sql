...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2025 a las 11:05:20
...
(1, 'Activo', 2, 'Netflix', 7.95, 'Estandár'),
(2, 'Activo', 1, 'Spotify', 7.65, 'Premium'),
(3, 'Activo', 1, 'HBO Max', 12.99, 'Estándar'),
(4, 'Activo', 5, 'Disney Plus', 10.99, 'Premium'),
(5, 'Activo', 2, 'Pluto tv', 2.99, 'Básico'),
(6, 'Activo', 3, 'Tubi tv', 5.00, 'Estandar');
...
(5, 'ACTIVA', '2025-08-31', '2025-07-31', 2, 5),
(6, 'Inactivo', '2026-02-04', '2025-11-04', 6, 4);
